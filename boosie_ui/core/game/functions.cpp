...
//bool Com_IsInGame()
//{
//	clientUIActive_t* client_ui_active = (clientUIActive_t*)*(int*)0x35E7DE0;
//	return ((client_ui_active[0].flags & 1) == 0 || client_ui_active[0].connectionState <= 3)
//		&& ((client_ui_active[1].flags & 1) == 0 || client_ui_active[1].connectionState <= 3)
//		&& ((client_ui_active[2].flags & 1) == 0 || client_ui_active[2].connectionState <= 3)
//		&& ((client_ui_active[3].flags & 1) == 0 || client_ui_active[3].connectionState < 4);
//}
//
